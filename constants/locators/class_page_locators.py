...
ENGLISH_VALUE = 'typing'
LANGUAGE = '[name=\'language\']'
LANGUAGE_VALUE = 'en'
STATUS = '[name=\'status\']'
STATUS_VALUE = 'active'
CLASS_NAME_FIELD = '[name=\'name\']'
GRADE = '[name=\'grade\']'
PERIOD = '[name=\'period\']'
...
CLASS_NAME_INSIDE_TABLE = "tbody td:nth-child(2) div[class='flex items-center']"
STUDENT_COUNT = "tbody td:nth-child(5) div[class='flex items-center']"
